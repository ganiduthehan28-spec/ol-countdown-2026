...
const PreparationProgress: React.FC<PreparationProgressProps> = ({ startDate, endDate }) => {
  ...
  return (
    <div className="mt-10 p-5 bg-card-background rounded-lg shadow-lg max-w-xl w-11/12 text-center text-text-color">
      ...
      <div className="w-full bg-border-color rounded-full h-4 mt-4">
        <div
          className="bg-secondary-color h-4 rounded-full"
